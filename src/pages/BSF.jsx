...
const BSF = () => {
    ...
    return (
        <div style={{ backgroundColor: '#ffffff', color: '#1e293b', overflow: 'hidden' }}>
            ...
            {/* ── SECTION 3: ORGANIC VS TRADITIONAL ── */}
            <section 
                className="bsf-comparison-section"
                style={{
                    background: '#ffffff',
                    padding: '8rem 0',
                    position: 'relative',
            ...
            >
                <div className="container">
                    <SectionTitle 
                        ...
                        title={<span>Organic vs <span style={{ color: '#64748b' }}>Traditional</span></span>}
                        description="Why BSF-derived organic fertilizer is the superior choice for long-term agricultural success and environmental health."
                    />
                    ...
                    >
                        <img 
                            src="/C:/Users/Shiv Ganga/.gemini/antigravity/brain/b9e8aae2-c20f-4d98-bcc4-7e18a79b4cbe/organic_vs_traditional_fertilizer_comparison_1774543483646.png" 
                            alt="Organic vs Traditional Fertilizer Comparison" 
